...
<div class="col-xs-12 col-sm-12 col-md-12  text-center "
    ...
    <div class="row text-center" style="display: flex; align-items: center; justify-content: center;">
        <form action="{{ route('localidades.update',$localidade->id) }}" method="POST" style="width: 90%">
            @csrf
            @method('PUT')
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group row">
                    <div class="col">
                        <input type="text" name="localidad" class="form-control" value="{{ $localidade->localidad }}">
                    </div>
